...
export default props => {
    ...
    return (
        <ComicContext.Provider value={{comics:comicsList,loading:loading,user:user,isLogin:isLogin,updateLogin:setIsLogin,updateUser:setUser}}>
            {props.children}
